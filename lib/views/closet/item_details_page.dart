...
class _ItemDetailsPageState extends State<ItemDetailsPage> {
  // Using a local controller instance if Provider isn't set up globally for delete
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        // Use subCategory as title
        title: Text(widget.item.subCategory, 
  ...
  void _confirmDelete(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text("Are you sure you want to permanently delete this ${widget.item.subCategory}?"),
        actions: [
          TextButton(
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              await _controller.deleteItem(widget.item.id);
              if (context.mounted) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Display the 6 specific AI-classified tags as requested
